...
%         'Color', cmap(i-(idx(1)-1),:), 'LineWidth', 1.5);hold on
     ps = polarscatter(deg2rad(tmp_dir(i)), tmp_len(i), 'Marker', 'o', 'MarkerFaceColor', cmap(i-(idx(1)-1),:),'MarkerEdgeColor', 'none', 'SizeData', sz);hold on
     p1 = polarscatter(deg2rad(p1_dir(i)), p1_tlt(i), 'Marker', 'x','LineWidth', lw, 'MarkerEdgeColor',  cmap_p1(i-(idx(1)-1),:), 'SizeData', sz);hold on
     p2 = polarscatter(deg2rad(p2_dir(i)), p2_tlt(i), 'Marker', '+','LineWidth', lw, 'MarkerEdgeColor', cmap_p2(i-(idx(1)-1),:), 'SizeData', sz);hold on  
end
