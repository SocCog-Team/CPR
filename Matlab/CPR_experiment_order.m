...
dte                 = [x.DateTraining x.DateSolo1 x.DateSolo2 x.DateAgent x.DateDyadic1 x.DateDyadic2 x.DateDyadic3];
...
cmap                = [0 0 0; col(1,:); col(2,:); col(2,:); col(3,:); col(4,:); col(4,:)];
...
h(3)                = plot(NaN,NaN,'.','Color', cmap(3,:));
h(4)                = plot(NaN,NaN,'.','Color', cmap(5,:));
h(5)                = plot(NaN,NaN,'.','Color', cmap(6,:));
[lg,icons]          = legend(h, 'TBD','Training','Solo', 'Dyadic_Computer', 'Dyadic_Human', 'Interpreter', 'none');
