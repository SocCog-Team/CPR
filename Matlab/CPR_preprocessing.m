...
for iSubj = 11 %1:length(sbj_lst)
    ...
    % Exclude subjects
    if strcmp(sbj_lst{iSubj},'HuA') || strcmp(sbj_lst{iSubj},'NaW')
        continue
    end
    ...
    if ~isnat(x.DateSolo1(iSubj))
        ...
        [t1,d1,s1]          = CPR_psych_import(sbj_lst{iSubj}, data_pth, fname_SOLO1);
        [t2,d2,s2]          = CPR_psych_import(sbj_lst{iSubj}, data_pth, fname_SOLO2);
    end
    ...
    if ~isnat(x.DateAgent(iSubj))
        ...
        [t1,d1,s1]          = CPR_psych_import([sbj_lst{iSubj} 'Agnt'], data_pth, fname_AGNT1);
        [t2,d2,s2]          = CPR_psych_import([sbj_lst{iSubj} 'Agnt'], data_pth, fname_AGNT2);
    end
    ...
    if ~isnat(x.DateSolo2(iSubj))
        ...
        [t1,d1,s1]          = CPR_psych_import(sbj_lst{iSubj}, data_pth, fname_SOLO1r);
        [t2,d2,s2]          = CPR_psych_import(sbj_lst{iSubj}, data_pth, fname_SOLO2r);
    end
