...
if label_neg
    print(f, [dest_dir '/SFIG_auc_labelled'], '-r500', '-dpng');
    print(f, [dest_dir '/SFIG_auc_labelled'], '-r500', '-dsvg', '-painters');
else
    print(f, [dest_dir '/SFIG_auc'], '-r500', '-dpng');
    print(f, [dest_dir '/SFIG_auc'], '-r500', '-dsvg', '-painters');
end
...
if label_neg
    print(f, [dest_dir '/SFIG_auc_labelled_corrP1'], '-r500', '-dpng');
    print(f, [dest_dir '/SFIG_auc_labelled_corrP1'], '-r500', '-dsvg', '-painters');
else
    print(f, [dest_dir '/SFIG_auc_corrP1'], '-r500', '-dpng');
    print(f, [dest_dir '/SFIG_auc_corrP1'], '-r500', '-dsvg', '-painters');
end
...
if label_neg
    print(f, [dest_dir '/SFIG_auc_labelled_hist'], '-r500', '-dpng');
    print(f, [dest_dir '/SFIG_auc_labelled_hist'], '-r500', '-dsvg', '-painters');
else
    print(f, [dest_dir '/SFIG_auc_hist'], '-r500', '-dpng');
    print(f, [dest_dir '/SFIG_auc_hist'], '-r500', '-dsvg', '-painters');
end
...
print(f, [dest_dir '/SFIG_dff_scatter_' subset_str], '-r500', '-dpng');
print(f, [dest_dir '/SFIG_dff_scatter_' subset_str], '-r500', '-dsvg', '-painters');
