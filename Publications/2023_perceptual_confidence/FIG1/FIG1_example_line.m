...
ax                  = gca; hold on
p                   = plot(ts,rdp_coh,'LineWidth',lw*1.5,'Color', [0 0 0]);
ax.YLabel.String    = {'RDP coherence';'[%]'};
ax.XLabel.String    = 'Time [s]';
ax.FontSize         = fs;
ax.YTick            = [0 .25 .5 .75 1];
...
print(f, [dest_dir '/rdp_example_line_coh'], '-r500', '-dpng');
print(f, [dest_dir '/rdp_example_line_coh'], '-r500', '-dsvg');
