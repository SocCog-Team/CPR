...
%%% PLOT PARAMS %%%
dest_dir                    = '/Users/fschneider/Documents/GitHub/CPR/Publications/2023_perceptual_confidence/FIG3/';
rcol                       	= [.6 .1 .1];
scol                        = [.1 .1 .1];
hcol                        = [.1 .1 .1];
lw                         	= 1;
...
if label_neg
    print(f, [dest_dir '/FIG3_auc_labelled'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG3_auc_labelled'], '-r500', '-dsvg', '-painters');
else
    print(f, [dest_dir '/FIG3_auc'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG3_auc'], '-r500', '-dsvg', '-painters');
end
...
if label_neg
    print(f, [dest_dir '/FIG3_auc_labelled_hist'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG3_auc_labelled_hist'], '-r500', '-dsvg', '-painters');
else
    print(f, [dest_dir '/FIG3_auc_hist'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG3_auc_hist'], '-r500', '-dsvg', '-painters');
end
...
print(f, [dest_dir '/FIG3_dff_scatter'], '-r500', '-dpng');
print(f, [dest_dir '/FIG3_dff_scatter'], '-r500', '-dsvg', '-painters');
...
print(f, [dest_dir '/FIG3_dff_solo_dyad'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG3_dff_solo_dyad'], '-r500', '-dpng', '-painters');
...
print(f, [dest_dir '/FIG3_corr_solo_dyad'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG3_corr_solo_dyad'], '-r500', '-dpng', '-painters');
...
print(f, [dest_dir '/FIG3_corr_solo_auc'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG3_corr_solo_auc'], '-r500', '-dpng', '-painters');
...
print(f, [dest_dir '/FIG3_corr_solo_score'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG3_corr_solo_score'], '-r500', '-dpng', '-painters');
