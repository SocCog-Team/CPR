...
if label_neg
    print(f, [dest_dir '/FIG_auc_labelled'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG_auc_labelled'], '-r500', '-dsvg', '-painters');
else
    print(f, [dest_dir '/FIG_auc'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG_auc'], '-r500', '-dsvg', '-painters');
end
...
if label_neg
    print(f, [dest_dir '/FIG_auc_labelled_hist'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG_auc_labelled_hist'], '-r500', '-dsvg', '-painters');
else
    print(f, [dest_dir '/FIG_auc_hist'], '-r500', '-dpng');
    print(f, [dest_dir '/FIG_auc_hist'], '-r500', '-dsvg', '-painters');
end
...
print(f, [dest_dir '/FIG_dff_scatter'], '-r500', '-dpng');
print(f, [dest_dir '/FIG_dff_scatter'], '-r500', '-dsvg', '-painters');
...
print(f, [dest_dir '/FIG_dff_solo_dyad'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG_dff_solo_dyad'], '-r500', '-dpng', '-painters');
...
print(f, [dest_dir '/FIG_corr_solo_dyad'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG_corr_solo_dyad'], '-r500', '-dpng', '-painters');
...
print(f, [dest_dir '/FIG_corr_solo_auc'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG_corr_solo_auc'], '-r500', '-dpng', '-painters');
...
print(f, [dest_dir '/FIG_corr_solo_score'], '-r500', '-dsvg', '-painters');
print(f, [dest_dir '/FIG_corr_solo_score'], '-r500', '-dpng', '-painters');
